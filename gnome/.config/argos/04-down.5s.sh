...
echo "---"
echo "🎉️ Download | terminal=false bash='${HOME}/github/dwm-main/.dwm/scripts/vdown'"
echo "👾️ Video Down | bash='gedit ${HOME}/github/dwm-main/.dwm/scripts/vdown' terminal=false"
