...
convert -size "${dimensions}" -background "#990000" "$HOME/gitlab/lnxpcs/distro/arch/arch-linux-n1.png" -gravity center "/tmp/teste.png"

convert "$HOME/gitlab/lnxpcs/distro/arch/arch-linux-n1.png" -gravity center -resize "${dimensions}>" \
	-background "$dominant" -extent "${dimensions}" \
	"/tmp/teste.png"
