...
BASE="base base-devel linux linux-firmware efibootmgr lvm2 intel-ucode btrfs-progs grub dhcpcd sudo nano git terminus-font xorg-server xorg-xinit nvidia"
